...
use Xolens\PgLaraimporter\App\Model\View\ImportFieldView;
use Xolens\PgLaraimporter\App\Repository\ImportFieldRepository;
use Xolens\PgLarautil\App\Repository\AbstractReadableRepository;
use Xolens\PgLarautil\App\Util\Model\Filterer;
use Xolens\PgLarautil\App\Util\Model\Sorter;

class ImportFieldViewRepository extends AbstractReadableRepository implements ImportFieldViewRepositoryContract
{
    public function model(){
        return ImportFieldView::class;
    }
     public function paginateByImport($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(ImportField::IMPORT_PROPERTY, $parentId);
     ...
     public function paginateByField($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(ImportField::FIELD_PROPERTY, $parentId);
        return $this->paginateFiltered($parentFilterer, $perPage, $page,  $columns, $pageName);
     }
