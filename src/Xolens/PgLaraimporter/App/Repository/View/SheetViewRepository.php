...
use Xolens\PgLaraimporter\App\Model\View\SheetView;
use Xolens\PgLaraimporter\App\Repository\SheetRepository;
use Xolens\PgLarautil\App\Repository\AbstractReadableRepository;
use Xolens\PgLarautil\App\Util\Model\Filterer;
use Xolens\PgLarautil\App\Util\Model\Sorter;

class SheetViewRepository extends AbstractReadableRepository implements SheetViewRepositoryContract
{
    public function model(){
     ...
     public function paginateByImport($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        ...
        $parentFilterer->equals(Sheet::IMPORT_PROPERTY, $parentId);
